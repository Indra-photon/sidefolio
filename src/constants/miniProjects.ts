export const miniProjects = [
  ...
  },
  {
    ...
    githubUrl: "", // Add if available
    technologies: ["React", "Chart.js", "Firebase", "Tailwind CSS", "PWA"],
...
export const miniProjectsShowcase = {
  emoji: "🚀",
  name: "Mini Projects",
  tagline: "Innovative solutions built with modern technologies",
  description: "A collection of carefully crafted applications showcasing various technologies and problem-solving approaches.",
  highlights: [
