...
export const servicesData: Service[] = [
  ...
  },
  {
    ...
    description: <>Improving website visibility and performance through targeted SEO strategies and data-driven insights using <span className="text-neutral-300 text-md sm:text-md md:text-xl">Google Analytics</span>, <span className="text-neutral-300 text-md sm:text-md md:text-xl">Google Search Console</span>, and <span className="text-neutral-300 text-md sm:text-md md:text-xl">Google Tag Manager</span>.</>,
  ...
  },
  {
    ...
    description: "Creating Minimum Viable Products (MVP) that validate your business idea with real users and reduce time to market.",
