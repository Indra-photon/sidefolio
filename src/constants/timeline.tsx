export const timeline = [
  {
    ...
    date: "2025 - Present",
    description: "Building the future of social networking and psychology analysis platforms",
    responsibilities: [
      "Developed a animated and responsive UI for the platform using React and Tailwind CSS",
      "Building UI/UX of QUEST, a platform for psychology analysis test using AI ",
      "Built a data based admin dashboard for managing user data and content",
    ],
  },
  // {
  //   company: "Google",
